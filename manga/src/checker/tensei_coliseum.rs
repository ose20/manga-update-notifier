...
const SHORT_TITLE: &str = "tensei_coliseum";

#[derive(Debug)]
pub struct TenseiColiseum {
    title: String,
    url: String,
    short_title: String,
}
...
#[async_trait]
impl MangaCrawler for TenseiColiseum {
...
impl_manga_info!(TenseiColiseum);

impl Manga for TenseiColiseum {}
